...
const Profile = ({auth, image, SetImage, firstName, lastName, ChangeField, HandleProfileSubmit, HandleError}) => {
  return(
    <div className="profile-container">
      ...
      <Button value="Create Profile" primary onClick={HandleProfileSubmit}/>
    </div>
  )
}
